...
(function () {
  ...
  async function preflight() {
    ...
    try {
      ...
      // Crude auth check: if we got bounced to a login page the response
      // body will mention the login form and will not mention the dashboard.
      ...
      logEvent('preflight_fail', { error: err && err.message });
      throw err;
    }
  }
